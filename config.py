...
OWNER_USERNAME = getenv("OWNER_USERNAME", "UNKNOWN07_000")
BOT_USERNAME = getenv("BOT_USERNAME", "")
BOT_NAME = getenv("BOT_NAME", "˹")
ASSUSERNAME = getenv("ASSUSERNAME", "")
EVALOP = list(map(int, getenv("EVALOP", "5247304559").split()))
...
OWNER_ID = int(getenv("OWNER_ID", 7189651838))

# Heroku deployment settings - Refer to Heroku documentation on how to obtain these
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/L2LUCKY/UNKNOWN7-MUSIC")
